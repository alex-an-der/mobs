...
$(document).ready(function() {
    ...
    $('#tabelle tfoot th').each( function () {
        ...
        $(this).html( '<input type="text" placeholder="Filtere '+title+'"  />' );
    } );
...
$alleUser = $dbm->query("select id, locked, mail, roles, lastlogin, created from y_user where validated > 0", array(), true);
...
foreach($alleUser as $user){
    ...
    if ($ersterlauf){
        ...
        $header .= "<tr><th>locked</th><th>Mailadresse</th><th>Rollengruppe</th><th>Letzter Log-In</th><th>Angelegt</th>";
        $spaltentoggler .= "<a class='toggle-vis' id='togvis0' data-column='0'></a>";
        $spaltentoggler .= "$togglertrenner<a class='toggle-vis' id='togvis1' data-column='1'></a>";
        $spaltentoggler .= "$togglertrenner<a class='toggle-vis' id='togvis2' data-column='2'></a>";
        $spaltentoggler .= "$togglertrenner<a class='toggle-vis' id='togvis3' data-column='3'></a>";
        $spaltentoggler .= "$togglertrenner<a class='toggle-vis' id='togvis4' data-column='4'></a>";
...
<a href= "./csv_export.php" target="_blank">&Uuml;bersicht exportieren</a>
</body>
</html>